...
|------|-----|--------------|
| Primary | `#123B68` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#28659B` | `--color-secondary` |
| Accent/CTA | `#A65F16` | `--color-accent` |
| Background | `#F6F8FB` | `--color-background` |
| Foreground | `#111C2C` | `--color-foreground` |
| Muted | `#EDF2F7` | `--color-muted` |
| Border | `#D9E1EA` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#28659B` | `--color-ring` |

**Color Notes:** Institutional navy + research accent + serif headings

### Typography

- **Heading Font:** Newsreader Variable
- **Body Font:** Inter Variable
- **Mood:** academic, contemporary, precise, editorial, readable
- **Loading:** Self-hosted with `@fontsource-variable/newsreader` and `@fontsource-variable/inter`
